...
There are several architectural approaches to handling this such as embeddings, which we’ll explore in the [next lesson](../lesson-05-embeddings/README.md).
...
In the [next lesson](../lesson-05-embeddings/README.md), we’ll explore embeddings - how meaning can be represented outside the context window, and how systems decide what information is worth bringing back in.
